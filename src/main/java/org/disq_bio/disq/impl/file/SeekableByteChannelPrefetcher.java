...
// This class is a copy of the version in GATK, with the Guava dependency removed.
// It should be replaced with the copy in google-cloud-nio:
// https://googlecloudplatform.github.io/google-cloud-java/google-cloud-clients/apidocs/com/google/cloud/storage/contrib/nio/SeekableByteChannelPrefetcher.html
// when it's possible to upgrade (currently not possible due to dependency conflicts).
// Ref: https://github.com/broadinstitute/gatk/issues/3500
...
public final class SeekableByteChannelPrefetcher implements SeekableByteChannel {
  ...
  public SeekableByteChannelPrefetcher(SeekableByteChannel chan, int bufSize) throws IOException {
    ...
    ThreadFactory threadFactory = createThreadFactory(nameFormat);
