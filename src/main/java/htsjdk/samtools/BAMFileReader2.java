...
public class BAMFileReader2 extends SamReader.ReaderImplementation {
   ...
   * record in the BAM file.
   */
  static long findVirtualOffsetOfFirstRecord(final SeekableStream seekableStream)
      throws IOException {
    final BAMFileReader2 reader =
        new BAMFileReader2(
            seekableStream,
  ...
  private class BAMFileIterator extends AbstractBamIterator {
    ...
    BAMFileIterator(final boolean advance) {
      ...
      this.bamRecordCodec.setInputStream(
          BAMFileReader2.this.mStream.getInputStream(),
          BAMFileReader2.this.mStream.getInputFileName());
        ...
        if (mNextRecord != null) {
          ...
          if (mValidationStringency != ValidationStringency.SILENT) {
            ...
            SAMUtils.processValidationErrors(
                validationErrors,
                this.samRecordIndex,
                BAMFileReader2.this.getValidationStringency());
          }
        }
